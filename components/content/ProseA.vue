...
<template>
  ...
  <a
    ...
    :href="href"
    class="group block rounded-2xl border border-white/10 bg-white/5 px-4 py-3 transition hover:border-[var(--accent)] hover:bg-[var(--accent)]/10"
    :target="isExternal ? '_blank' : undefined"
    :rel="isExternal ? 'noopener noreferrer' : undefined"
  >
    <div class="flex items-center gap-2 text-sm font-medium text-[var(--text)]">
      <span
    ...
    <p class="mt-1 text-xs text-white/70 transition group-hover:text-white">
