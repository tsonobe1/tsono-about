...
const selected = computed<PortfolioType>(() => {
    ...
    return (typeof q === 'string' && TYPES.some(t => t.key === q)) ? (q as PortfolioType) : 'app'
})
...
<template>
    <div class="mx-auto flex min-h-screen max-w-4xl flex-col gap-8 px-6 py-16">
        ...
        <section class="flex flex-col gap-8">
            <div class="flex flex-wrap items-center gap-4 border-b border-white/10 px-2 pb-4">
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                ...
                >
                    <div class="relative aspect-video overflow-hidden">
                        ...
                        />
                        <div class="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent opacity-0 transition duration-300 group-hover:opacity-100" />
                    </div>
