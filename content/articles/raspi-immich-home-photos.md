...
2024年6月から、自宅サーバを作って「おうちGoogleフォト」を運用している。
スマホで撮影した写真・動画をほぼ無制限に保存して、タイムライン・アルバムなどの機能で快適に閲覧ができる。

![Immichタイムラインの様子](/images/articles/raspi-immich-home-photos/introduction/immich_timeline.webp)
遠方の両親には孫専用アルバムを共有。モバイルアプリもあるのでスマホから見てもらえる。
...
容量を気にせずバンバン撮影したいので、👇の要件を満たす目標を立てた。
...
「サブスクしないこと」は写真を削除しない限り永続的に課金し続ける必要があるため。現在（2025/08）のデータは合計265.6GBある
これをサブスクで運用すると...
...
Googleでも年で ¥17,400 かかる。 個人的にはHDDを買って手元で管理するほうが精神衛生的に👍️
この記事では、
